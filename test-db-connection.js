// test-db-connection.js - Script simple para probar la conexión a la base de datos
...
async function testConnection() {
  try {
    ...
    try {
      ...
      console.log('No se pudo consultar la tabla usuarios. Es posible que no exista:', error.message);
